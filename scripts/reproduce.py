...
def main():
    ...
    if not args.fast:
        ...
        for desc, script, extra in [
            ...
            ("Phase 11: calibration bias vs noise (why online adaptation fails)",
             "run_calibration_bias.py", ["--seeds", "3"]),
            ("Phase 11: CADENCE hyperparameter sweep + LOSO + empirical-Bayes comparison",
